...
namespace PhysicsAdvertisements.MVC.Web.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IPhysicsAdvertisementsDbContext, PhysicsAdvertisementsDbContext>(new PerRequestLifetimeManager());
            container.RegisterType<IUserRepo, UserRepo>(new PerRequestLifetimeManager());
            container.RegisterType<IPhysicsAreasRepo, PhysicsAreasRepo>(new PerRequestLifetimeManager());
