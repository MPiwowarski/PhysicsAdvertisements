<%@ Page Language="C#" MasterPageFile="../Shared/Site.Master" AutoEventWireup="true" CodeBehind="Help.aspx.cs" Inherits="PhysicsAdvertisements.WebForms.Web.Forms.Home.Help" %>

<asp:Content ID="head" ContentPlaceHolderID="head" runat="server">
    <link href="../../App_Styles/Home/Help.css" rel="stylesheet" />
    <title>Help</title>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="help">
        <div class="questions">
            <h1>Here you can find most common questions and answers for them.</h1>
